...
import net.thelightbluegame.lithereal.mixin.AxeItemAccessor;
import net.thelightbluegame.lithereal.mixin.HoeItemAccessor;
import net.thelightbluegame.lithereal.mixin.ShovelItemAccessor;
...
public class ModAiotItem extends MiningToolItem {
    ...
    public ModAiotItem(float attackDamage, float attackSpeed, ToolMaterial material, Settings settings) {
