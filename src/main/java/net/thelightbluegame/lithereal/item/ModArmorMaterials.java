...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    LITHERITE("litherite", 18, new int[]{3, 5, 7, 3}, 10,
            SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.5F, 0.0F,
            () -> Ingredient.ofItems(ModItems.PURE_LITHERITE));
    ...
    public int getDurability(EquipmentSlot slot) {
        return this.BASE_DURABILITY[slot.getEntitySlotId()] * this.durabilityMultiplier;
    }
